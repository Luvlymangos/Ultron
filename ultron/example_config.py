...
bot_token = 'ADD DISCORD BOT TOKEN HERE'
...
dm_only = True  # bot responses always sent via direct message
...
killmail = {  # add or remove groups as needed, groups must have unique names.
    ...
    'killmailGroups': {
        'group1': {  # feel free to add additional groups, be sure that each group has a unique name
            'id': '498setup125261',  # Corp/Alliance ID
...
fcPings = {
    'allowedChannelIds':[00000000000000000] #Channels that this bot can post to
}
