...
class ExtensionManager(commands.Cog):
    ...
    async def reload_core(self, ctx):
        ...
        bot = ctx.bot
        try:
            bot.unload_extension('ultron.core.commands')
            bot.load_extension('ultron.core.commands')
            embed = utils.make_embed(msg_type='success',
    ...
    async def reload_dm(self, ctx):
        ...
        bot = ctx.bot
        try:
            bot.unload_extension('ultron.data_manager')
            bot.load_extension('ultron.data_manager')
            embed = utils.make_embed(msg_type='success',
