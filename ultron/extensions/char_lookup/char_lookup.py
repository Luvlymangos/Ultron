...
class CharLookup(commands.Cog):
    ...
    async def _char(self, ctx):
        ...
        ultron_intel = await self.ultron_intel(character_id, character_name, zkill_stats)
        ...
        try:
            ...
            if victim_alliance:
                embed.add_field(name="Ultron Intel Report", value=ultron_intel,
                                inline=False)
    ...
    async def ultron_intel(self, character_id, character_name, zkill_stats):
        global top_system
        try:
